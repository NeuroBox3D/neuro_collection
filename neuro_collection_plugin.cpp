...
static void Common(Registry& reg, string grp)
{
	...
	// test neurite projector
	{
		...
		reg.add_function("test_import_swc_and_regularize", static_cast<void (*)(const std::string&, number, const std::string&, const size_t)>(&test_import_swc_and_regularize), "", "file name # desired segment length", "");
